# Awesome Healthcare Recruitment [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of platforms, tools, and resources for healthcare recruiters, hospital HR directors, and medical staffing agencies.

This list covers the entire spectrum of medical hiring, from physician sourcing and nurse staffing to credentialing and compliance.

## Contents

- [Physician Sourcing](#physician-sourcing)
- [Nurse Staffing & Travel Nursing](#nurse-staffing--travel-nursing)
- [Healthcare Talent Platforms](#healthcare-talent-platforms)
- [Credentialing & Compliance](#credentialing--compliance)
- [Medical Job Boards](#medical-job-boards)
...
*Tools to manage medical licenses, DEA registrations, and provider enrollment.*

* [Modio Health](https://www.modiohealth.com) - A platform to simplify provider credentialing and compliance.
* [Verisys](https://verisys.com) - Data solutions for screening, verification, and monitoring of healthcare providers.
* [CAQH ProView](https://proview.caqh.org) - The industry standard for capturing and sharing self-reported healthcare provider data.

## Medical Job Boards
* [HealtheCareers](https://www.healthecareers.com)
* [DocCafe](https://www.doccafe.com)
* [HospitalRecruiting.com](https://www.hospitalrecruiting.com)
